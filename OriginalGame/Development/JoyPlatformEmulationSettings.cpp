...
#define LOCTEXT_NAMESPACE "JoyPlatformEmulationSettings"

UJoyPlatformEmulationSettings::UJoyPlatformEmulationSettings()
{
}

FName UJoyPlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName UJoyPlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName UJoyPlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void UJoyPlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UJoyPlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UJoyPlatformEmulationSettings::PostInitProperties()
{
...
void UJoyPlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void UJoyPlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> UJoyPlatformEmulationSettings::GetKnownPlatformIds() const
{
...
void UJoyPlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
