...
#include "QinPlatformEmulationSettings.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(QinPlatformEmulationSettings)

#define LOCTEXT_NAMESPACE "QinPlatformEmulationSettings"

UQinPlatformEmulationSettings::UQinPlatformEmulationSettings()
{
}

FName UQinPlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName UQinPlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName UQinPlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void UQinPlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UQinPlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UQinPlatformEmulationSettings::PostInitProperties()
{
...
void UQinPlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void UQinPlatformEmulationSettings::ApplySettings()
{
...
void UQinPlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> UQinPlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> UQinPlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void UQinPlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
