...
#include "QinGameplayCueManager.generated.h"
...
/**
 * UQinGameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class UQinGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	UQinGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UQinGameplayCueManager* Get();
