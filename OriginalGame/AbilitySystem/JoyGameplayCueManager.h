...
#include "JoyGameplayCueManager.generated.h"
...
/**
 * UJoyGameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class UJoyGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	UJoyGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UJoyGameplayCueManager* Get();
