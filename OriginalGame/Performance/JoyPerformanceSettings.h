...
#include "JoyPerformanceSettings.generated.h"
...
USTRUCT()
struct FJoyQualityDeviceProfileVariant
{
	GENERATED_BODY()
...
USTRUCT()
struct FJoyPerformanceStatGroup
{
	GENERATED_BODY()
...
public:
	UJoyPlatformSpecificRenderingSettings();

	// Helper method to get the performance settings object, directed via platform settings
	static const UJoyPlatformSpecificRenderingSettings* Get();
