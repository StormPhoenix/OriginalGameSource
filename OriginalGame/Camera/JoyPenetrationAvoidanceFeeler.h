...
#include "JoyPenetrationAvoidanceFeeler.generated.h"
...
struct FJoyPenetrationAvoidanceFeeler
{
	...
	/** how much this feeler affects the final position if it hits a APawn (setting to 0 will not attempt to collide
	 * with pawns at all) */
	UPROPERTY(EditAnywhere, Category = PenetrationAvoidanceFeeler)
	float PawnWeight;
