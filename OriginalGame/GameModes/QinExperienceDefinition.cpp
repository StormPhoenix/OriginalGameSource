...
#include UE_INLINE_GENERATED_CPP_BY_NAME(QinExperienceDefinition)

#define LOCTEXT_NAMESPACE "QinSystem"

UQinExperienceDefinition::UQinExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UQinExperienceDefinition::IsDataValid(TArray<FText>& ValidationErrors)
{
...
void UQinExperienceDefinition::UpdateAssetBundleData()
{
